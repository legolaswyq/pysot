...
def debug(imgs):
    ...
    cv2.resizeWindow("video", 648, 648)
    while True:
...
def large_bbox(bbox, im_w=324, im_h=324):
    """if a bbox's w is greater than half of the frame or 
    bbox's h is greater than half of the frame """
    xmin, ymin, xmax, ymax = bbox
    w = xmax - xmin
    h = ymax - ymin 
...
frames_dir = "/home/walter/git/pysot/data/OB_walter/94564761/100"
